...
export default function medicaladmission() {
  ...
  const filteredData = courses.filter(
    (item) => item.catagory === "engineering"
  );
            ...
            <div key={index} className="grid  mt-5 h-96">
              ...
              >
                ...
                <div className="flex justify-between p-3 bg-gray-100 mt-3">
                  ...
                  <button className="px-6 my-auto max-sm:px-3 py-2 hover:bg-gray-300 font-semibold rounded-lg flex justify-around bg-gray-200">
                    বিস্তারিত দেখি{" "}
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
